<?php
    ...
    $pagination_style = OhioOptions::get( 'pagination_type', 'standard' );
    ...
    <div id="primary" class="content-area">
        ...
        <div class="page-content<?php echo esc_attr( $sidebar_page_class ); ?>">
            <main id="main" class="site-main">
                <div class="vc_row archive-holder search-page <?php echo esc_attr( $grid_style_class ); ?>" data-lazy-container="posts">
                <?php
                global $wp_query;
                    $_post_i = 0;
                    ...
                    while ( have_posts() ) : the_post();
                        switch ( $post->post_type ) {
                            ...
                            default: // default post or undefined custom
                                ...
                                echo '<div class="' . esc_attr( $col_class . $grid_class . ( ( $posts_grid == 'masonry' ) ? ' masonry-block' : '' ) ) . '" ' . esc_attr( $_anim_attrs ) . ' data-lazy-item="" data-lazy-scope="posts">';
