...
<div>
	<ul class="products woo-products vc_row<?php echo esc_attr($grid_classes) ?>" <?php echo esc_html( $masonry_atts ); ?> data-lazy-container="products" <?php echo esc_attr($asymmetric_atts) ?>>
