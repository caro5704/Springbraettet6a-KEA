    ...
    acf_add_local_field_group([
        ...
        "fields" => [
            ...
            [
                ...
                "type" => "clone",
                "instructions" => __('Used for dark tone websites and a dark mode', 'ohio'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Site logo for header', 'ohio'),
            ...
            [
                ...
                "instructions" => __('Set a height for the site logo', 'ohio') . ' <em>' . __('(Use pixels)', 'ohio') . '</em>',
                "conditional_logic" => [
                    [
                        [
                            "field" => "field_59229bda32383",
