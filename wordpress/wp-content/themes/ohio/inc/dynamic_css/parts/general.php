...
if ( $buttons_css ) {
    $_selector = [
        '.button:not(.-outlined):not(.-text):not(.-flat)',
        'a.button:not(.-outlined):not(.-text):not(.-flat)',
        'input[type="submit"]'
    ];
...
if ( $buttons_color_css ) {
    $_selector = [
        ...
        '.button.-text:not(:hover)',
        'a.button.-text:not(:hover)', 
        'input[type="submit"].-text:not(:hover)'
    ];
