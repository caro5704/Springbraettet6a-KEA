...
<div class="portfolio-item -with-slider -full-vh -layout4" <?php if ( $project['in_popup']) { echo ' data-portfolio-popup="' . esc_attr( $project['popup_id']) . '"'; } ?>>
    ...
    <div class="project overlay -full-h">
        <div class="page-container -full-h">
            <div class="vc_col-lg-8 vc_col-md-12 project-content -left animated-holder">
                <?php if ( $project['show_video_button'] && (isset( $project['video']['link']) && !empty( $project['video']['link'])) ): ?>
                    <div class="video-button -animation open-popup<?php echo esc_attr( $video_button_style_class); ?>" data-video-module="<?php echo esc_url( $project['video']['link'] ); ?>">
