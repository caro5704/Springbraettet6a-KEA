...
<div class="portfolio-item -with-slider -full-vh -layout5" <?php if ( $project['in_popup']) { echo ' data-portfolio-popup="' . esc_attr( $project['popup_id']) . '"'; } ?>>
    ...
    <div class="project overlay">
        <div class="page-container -full-h">
            <div class="vc_col-lg-6 vc_col-lg-push-6 vc_col-md-12 project-content -left -full-h animated-holder">
