		...
		<div class="page-content<?php echo esc_attr( $sidebar_page_class ); ?>">
			<main id="main" class="site-main">
				...
				<?php if ( ! $is_slider ) : ?>
					...
					<div class="<?php if ( $projects_layout_item == 'grid_8' || $projects_layout_item == 'grid_12') { echo 'portfolio-links' . esc_attr( $fullscreen_classes ); } ?> <?php echo esc_attr( $projects_layout_item . $wrapper_classes ); ?>" data-ohio-portfolio-grid="true" <?php echo esc_attr( $grid_attr ); ?>>
				...
				<?php if ( $is_slider ) : ?>
					...
					<div class="portfolio-onepage-slider -slider-fs clb-slider-scroll-bar <?php echo esc_attr( $projects_layout_item . $fullscreen_classes ); ?>"
